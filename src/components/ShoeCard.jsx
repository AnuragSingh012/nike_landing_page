...
const ShoeCard = ({imgURL, changeBigShoeImage, bigShoeImage}) => {
  ...
  return (
    <div className={`border-2 border-yellow-400 rounded-xl ${bigShoeImage === imgURL.bigShoe ? 'border-[#ffc13a]' : 'border-transparent'} cursor-pointer max-sm:flex-1`} onClick={handleClick} >
